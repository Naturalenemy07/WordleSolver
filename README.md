...
### As of June 2023, Chrome for Testing is released, see [CfT](https://developer.chrome.com/blog/chrome-for-testing/) and [GoogleChromeLabs CfT](https://github.com/GoogleChromeLabs/chrome-for-testing#json-api-endpoints). I have transitioned to using Firefox as of 15Nov2024. Firefow does not require the use of ChromeDriver. The sections in wordle_solver.py are commented out regarding ChromeDriver.
